...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const sources = [
      { src: '/components/Home/Hero/mirai_home1.mov', type: 'video/mp4' }
    ]
    ...
    <section style={{ 
      ...
      >
        <p style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff' }}>
          Video not supported — <a href="/components/Home/Hero/mirai_home1.mov" style={{ color: '#fff', textDecoration: 'underline' }}>download</a>
        </p>
      </video>
